...
var AvatarLoader = function (_React$Component) {
  ...
  _createClass(AvatarLoader, [{
    ...
    key: 'initiateLoad',
    value: function initiateLoad() {
      var _this2 = this;

      this.imageObj.onload = function () {
        // image loaded success fully
        _this2.setState({
          currentSource: _this2.props.src
        });
      };
    ...
    value: function render() {
      ...
      return this.state.currentSource ? _react2.default.createElement('img', { className: className, style: style, src: this.state.currentSource }) : _react2.default.createElement(_avatar2.default, { className: className, style: style });
    }
  }]);
